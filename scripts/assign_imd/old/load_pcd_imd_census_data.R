...
hh_stc <- data.table(read_csv(here::here('data','census','raw','household_size_tenure_composition.csv'), show_col_types = F))
...
hh_tc <- data.table(read_csv(here::here('data','census','raw','household_tenure_composition.csv'), show_col_types = F))
